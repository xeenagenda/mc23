...
literalSymbolCodeLength = inflate_data
controlSymbolCodeLength = literalSymbolCodeLength+256

; Huffman trees

nBitCode_clearFrom = controlSymbolCodeLength+CONTROL_SYMBOLS
nBitCode_literalCount = nBitCode_clearFrom
nBitCode_controlCount = nBitCode_literalCount+2*TREE_SIZE
nBitCode_literalOffset = nBitCode_controlCount+2*TREE_SIZE
nBitCode_controlOffset = nBitCode_literalOffset+2*TREE_SIZE
codeToLiteralSymbol = nBitCode_controlOffset+2*TREE_SIZE
codeToControlSymbol = codeToLiteralSymbol+256
inflate_data_end = codeToControlSymbol+CONTROL_SYMBOLS
